...
export interface InitOutput {
    ...
    readonly create_keystore: (a: number, b: number) => [number, number, number, number];
    readonly decrypt_message: (a: number, b: number) => [number, number, number, number];
    readonly derive_accounts: (a: number, b: number) => [number, number, number, number];
    readonly derive_message_key_pair: (a: number, b: number) => [number, number, number, number];
    readonly encrypt_message: (a: number, b: number) => [number, number, number, number];
    readonly export_mnemonic: (a: number, b: number) => [number, number, number, number];
    readonly sign_message: (a: number, b: number) => [number, number, number, number];
    readonly sign_message_event: (a: number, b: number) => [number, number, number, number];
    readonly sign_psbt: (a: number, b: number) => [number, number, number, number];
    readonly sign_psbts: (a: number, b: number) => [number, number, number, number];
    readonly sign_tx: (a: number, b: number) => [number, number, number, number];
    readonly sign_txs: (a: number, b: number) => [number, number, number, number];
