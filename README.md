...
底层隐私代币能力基于团队提出的 **[EIP-8065](https://eips.ethereum.org/EIPS/eip-8065)**（ZWToken思路）；本仓库侧重 Demo 集成与产品体验，不展开协议细节。
...
如果很懒，也可以访问Demo网址[http://47.83.115.228:3000](http://47.83.115.228:3000)。
